...
public class GameplayManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        GameColorManager.Instance.IsInitialized = true;
    ...
    private void Update()
    {
        if(Input.GetMouseButtonDown(0) && !hasGameFinished)
        {
            ...
            int clickedScoreId = hit.collider.gameObject.GetComponent<PlayerColor>().ColorId;
    ...
    [SerializeField] private ScoreColor _scorePrefab;
    private ScoreColor CurrentScore;

    private IEnumerator SpawnScore()
    {
        ScoreColor prevScore = null;
    ...
    public void GameEnded()
    {
        ...
        GameColorManager.Instance.CurrentScore = (int)score;
    ...
    private IEnumerator GameOver()
    {
        ...
        GameColorManager.Instance.GoToMainMenu();
    }
